...
//		//System.out.println(Arrays.deepToString(semSub));
		...
		System.out.println("Semster 2 Subject 4 Name is : "+marksheet[1][0][3]+ " and Subject 5 Name is : " +marksheet[1][0][5]);
		
		// Print the Status/Marks of Semester 4 Subject 3 and Subject 6
		System.out.println("Status/Marks of Semster 4 Subject 3 is : "+marksheet[3][1][2] +" and Status/Marks for Subject 6 is : " + marksheet[3][01][5]);
